  ...
  settings: {
    general: {
      ...
      mode: {
        type: Types.String,
        required: true,
        enum: ["conquest", "battleRoyale", "kingOfTheHill"],
        default: "conquest",
      },
    ...
    diplomacy: {
      ...
      upkeepCost: {
        type: Types.String,
        required: true,
        enum: ["none", "cheap", "standard", "expensive", "crazyExpensive"],
        default: "none",
      },
      globalEvents: {
        type: Types.String,
    ...
    gameTime: {
      ...
      maxTurnWait: {
        type: Types.Number,
        required: true,
        enum: [1, 5, 10, 30, 60, 360, 480, 600, 720, 1080, 1440, 2880],
        default: 1440,
      }, // Time in minutes
      isTickLimited: {
        type: Types.String,
