...
export default (
  ...
  router.post("/api/user/", controller.create, mw.core.handleError);

  router.get("/api/user/settings", controller.getSettings, mw.core.handleError);
  ...
  router.get("/api/user/:id", controller.detail, mw.core.handleError);
