...
export default (
  ...
  router.get("/api/game/flux", controller.getFlux, mw.core.handleError);
      ...
      try {
        if (req.game.settings.general.createdByUserId) {
          req.game.settings.general.isGameAdmin =
            req.game.settings.general.createdByUserId.toString() ===
  ...
  router.put(
    "/api/game/:gameId/inviteTeamMember",
    mw.auth.authenticate(),
    mw.game.loadGame({
      lean: false,
      settings: true,
  ...
  router.patch(
    "/api/game/:gameId/removeInviteeFromTeam",
    mw.auth.authenticate(),
    mw.game.loadGame({
      lean: false,
      settings: true,
    ...
    controller.removeInviteeFromTeam,
    mw.core.handleError
  );
  router.put(
