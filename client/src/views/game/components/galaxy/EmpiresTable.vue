      ...
      <table class="table table-striped table-hover mb-0">
          <thead class="table-dark">
              <tr>
                  ...
                  <td class="text-end" title="Ships"><a href="javascript:;" @click="sort('totalShips')"><i class="fas fa-rocket"></i></a></td>
                  <td class="text-end" title="Ship Production"><a href="javascript:;" @click="sort('newShips')"><i class="fas fa-gears"></i></a></td>
                  <td class="text-end" title="Economy"><a href="javascript:;" @click="sort('totalEconomy')"><i class="fas fa-scale-balanced"></i></a></td>
