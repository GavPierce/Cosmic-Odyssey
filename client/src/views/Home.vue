...
export default {
  ...
  data() {
    return {
      ...
      words: ["BLAST-OFF", "EXPLORE", "CONQUER", "TEAM-UP", "ADAPT", "BUILD", "COMMUNICATE",
       "TRADE", "DISCOVER", "DEVELOP", "DECIMATE", "DEFEAT", "DETHRONE", "DRIFT", "DESTROY", "DEFEND",
        "DETECT", "TERRAFORM", "COLONIZE", "ADMINISTER", "ANTICIPATE", "ASCEND", "ATTACK", "ACHIEVE", "ACCOMPLISH", "ACTIVATE",
         "ACQUIRE", "ADVANCE", "AMAZE", "ASSIST", "AMBUSH", "ANALYZE", "REPAIR", "ALLY", "BATTLE", "BRIBE", "ELIMINATE", "ENJOY",
          "EXPLOIT", "WARP", "RECRUIT", "EMBARK", "FIGHT", "FEDERATE", "NAVIGATE", "VOYAGE", "RAID", "MARAUDE", "RESEARCH",
           "EXPERIMENT", "LAUNCH", "FIRE", "DOMINATE", "RULE", "PROTECT", "INVESTIGATE", "LEAD", "COMMAND", "NEGOTIATE",
            "SABOTAGE", "DEMOLISH", "CAPTURE", "PILOT", "OPERATE", "HUNT", "LAUNCH", "TERMINATE", "HACK", "TARGET", "TRAVEL",
             "TRANSFORM", "TRAVERSE", "THRIVE", "TELEPORT", "SYNCHRONIZE", "SYNERGIZE", "SWARM", "INVADE"],
      wordIndex: 0,
      letterIndex: 0,
      currentText: "",
      typing: true,
