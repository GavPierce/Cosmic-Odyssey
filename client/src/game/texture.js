...
class TextureService {
  ...
  initialize() {
    ...
    this.CARRIER_TEXTURE = new PIXI.Texture(
    ...
    this.STAR_TEXTURE = new PIXI.Texture(
      PIXI.BaseTexture.from(require("../assets/stars/star.png"))
    );

    // STARLESS NEBULAS
    this.STARLESS_NEBULA_TEXTURES.push(
      new PIXI.Texture(
        PIXI.BaseTexture.from(require("../assets/nebula/neb0-starless.png"))
      )
    );
    this.STARLESS_NEBULA_TEXTURES.push(
      new PIXI.Texture(
        PIXI.BaseTexture.from(require("../assets/nebula/neb1-starless.png"))
      )
    );

    // STAR NEBULAS
    this.STAR_NEBULA_TEXTURES.push(
      new PIXI.Texture(
        PIXI.BaseTexture.from(require("../assets/nebula/star-nebula-0.png"))
      )
    );
    this.STAR_NEBULA_TEXTURES.push(
      new PIXI.Texture(
        PIXI.BaseTexture.from(require("../assets/nebula/star-nebula-1.png"))
      )
    );
    this.STAR_NEBULA_TEXTURES.push(
      new PIXI.Texture(
        PIXI.BaseTexture.from(require("../assets/nebula/star-nebula-2.png"))
      )
    );
    ...
    this.STAR_ASTEROID_FIELD_TEXTURES.push(
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/stars/star-asteroid-field-0.png")
        )
      )
    );
    this.STAR_ASTEROID_FIELD_TEXTURES.push(
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/stars/star-asteroid-field-1.png")
        )
      )
    );
    this.STAR_ASTEROID_FIELD_TEXTURES.push(
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/stars/star-asteroid-field-2.png")
        )
      )
    );

    this.STAR_WORMHOLE_TEXTURES.push(
      new PIXI.Texture(
        PIXI.BaseTexture.from(require("../assets/stars/vortex.png"))
      )
    );
    ...
    this._loadSpecialistTexture("space-needle");
  ...
  _loadSpecialistTexture(name) {
    this.SPECIALIST_TEXTURES[name] = PIXI.Texture.from(
      require(`../assets/specialists/${name}.svg`)
    );
    //disable mipmap
  ...
  _loadPlayerSymbols() {
    this.PLAYER_SYMBOLS["circle"] = [
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_circle.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_circle_warp_gate.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_circle_partial.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_circle_partial_warp_gate.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/128x128_circle_carrier.svg")
        )
      )
    ];
    this.PLAYER_SYMBOLS["hexagon"] = [
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_hexagon.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_hexagon_warp_gate.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_hexagon_partial.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_hexagon_partial_warp_gate.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/128x128_hexagon_carrier.svg")
        )
      )
    ];
    this.PLAYER_SYMBOLS["diamond"] = [
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_diamond.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_diamond_warp_gate.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_diamond_partial.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_diamond_partial_warp_gate.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/128x128_diamond_carrier.svg")
        )
      )
    ];
    this.PLAYER_SYMBOLS["square"] = [
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_square.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_square_warp_gate.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_square_partial.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/256x256_square_partial_warp_gate.svg")
        )
      ),
      new PIXI.Texture(
        PIXI.BaseTexture.from(
          require("../assets/map-objects/128x128_square_carrier.svg")
        )
      )
    ];
  }
  ...
  _loadStarSymbols() {
    this.STAR_SYMBOLS["scannable"] = new PIXI.Texture(
      PIXI.BaseTexture.from(
        require("../assets/map-objects/128x128_star_scannable.svg")
      )
    );
    this.STAR_SYMBOLS["unscannable"] = new PIXI.Texture(
      PIXI.BaseTexture.from(
        require("../assets/map-objects/128x128_star_unscannable.svg")
      )
    );
    this.STAR_SYMBOLS["home"] = new PIXI.Texture(
      PIXI.BaseTexture.from(
        require("../assets/map-objects/128x128_star_home.svg")
      )
    );
    this.STAR_SYMBOLS["black_hole"] = new PIXI.Texture(
      PIXI.BaseTexture.from(
        require("../assets/map-objects/128x128_star_black_hole.svg")
      )
    );
    this.STAR_SYMBOLS["black_hole_binary"] = new PIXI.Texture(
      PIXI.BaseTexture.from(
        require("../assets/map-objects/128x128_star_black_hole_binary.svg")
      )
    );
    this.STAR_SYMBOLS["binary_scannable"] = new PIXI.Texture(
      PIXI.BaseTexture.from(
        require("../assets/map-objects/128x128_star_scannable_binary.svg")
      )
    );
    this.STAR_SYMBOLS["binary_unscannable"] = new PIXI.Texture(
      PIXI.BaseTexture.from(
        require("../assets/map-objects/128x128_star_unscannable_binary.svg")
      )
    );
  }
  ...
  getRandomStarNebulaTexture(seed) {
    ...
    let index = Math.floor(
      TextureService.seededRNG.random() * this.STAR_NEBULA_TEXTURES.length
    );
